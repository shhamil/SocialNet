    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about_me', models.CharField(blank=True, max_length=255, verbose_name='О себе')),
                ('avatar', models.ImageField(blank=True, upload_to=accaunt.services.get_unical_name, verbose_name='Аватарка')),
